...
from Tests.Product import Product
...
Manage_Products_test = unittest.TestLoader().loadTestsFromTestCase(Product)

#   Creating a Test Suite using the imported Test Case Files
test_full = unittest.TestSuite([Manage_Products_test])
