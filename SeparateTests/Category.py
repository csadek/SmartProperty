...
from Tests.Category import Category
...
Manage_Category_test = unittest.TestLoader().loadTestsFromTestCase(Category)

#   Creating a Test Suite using the imported Test Case Files
test_full = unittest.TestSuite([Manage_Category_test])
