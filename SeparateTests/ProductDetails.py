...
from Tests.ProductDetails import ProductDetails
...
Product_Details_test = unittest.TestLoader().loadTestsFromTestCase(ProductDetails)

#   Creating a Test Suite using the imported Test Case Files
test_full = unittest.TestSuite([Product_Details_test])
