...
from Tests.FlashSale import FlashSale
...
Add_Flash_Sale_test = unittest.TestLoader().loadTestsFromTestCase(FlashSale)

#   Creating a Test Suite using the imported Test Case Files
test_full = unittest.TestSuite([Add_Flash_Sale_test])
